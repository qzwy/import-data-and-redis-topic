...
import zwy.importdata.model.FrontData;
...
//  }
  ...
  public void sendMessage() {
      stringRedisTemplate.convertAndSend("total",productTotalData().toJSONString());
    stringRedisTemplate.convertAndSend("line",productLineData().toString());
...
//    return result;
//  }
  public JSONObject productTotalData() {
  ...
  public List<JSONObject> productLineData() {
